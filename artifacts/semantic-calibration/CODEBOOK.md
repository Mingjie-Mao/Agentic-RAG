# 语义标注 codebook v3（2026-09-24 冻结；v2 存档于 `CODEBOOK-v2.md`）
...
> 来源：负责人 2026-09-23 对第 1 轮分歧的四项裁决（`ADJUDICATION.md` 决定 1–4）。v2 只把它们写进了
> 裁决脚本，没有写进 codebook，所以第 2 轮标注包仍按 v2 标——这是 v3 要补的缺口。
...
口径说明：负责人对 `B2-MH-0f910380b759#3`（主语是 Kelce 的意图）裁定 `related`；同题 #1、#2
以 Taylor Swift 为主语，gold 为 `answers`。本条按这一对先例取最窄的推广，与第 1 轮既有 gold 不冲突。
