...
| 基础 Agent 题过于简单 | 30 题中 fact 11、compound 10；单次 RAG 与 workflow 均 30/30 | 保留为 Basic Regression；另建 30 题 Hard Benchmark | 分批运行三条路径并分析轨迹 |
| 动态 Agent 太慢 | 定向困难题约 142–304 秒；修复前 5 题中位 157.4 秒 | 自动路由走固定 workflow；公网禁用动态模式 | 真实轨迹上的停止、恢复和无效工具分析 |
